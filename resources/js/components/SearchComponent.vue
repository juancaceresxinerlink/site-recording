<template>
  <div class="row">
    ...
    <div class="col-12 col-md-4">
      <div class="form-group row">
        <label class="col-sm-4 col-form-label text-right">Extensión:</label>
        <div class="col-sm-8">
          <input
            type="text"
            class="form-control"
          ...
          <small
            ...
            class="text-danger font-weight-bold"
          >
            El campo "Extensión" solo puede contener letras y números.
          </small>
        </div>
      </div>
    </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          ...
          <small
            ...
            class="text-danger font-weight-bold"
            >El campo "DNI" solo puede contener letras y números.</small
          >
        </div>
      </div>
    </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          ...
          <small
            ...
            class="text-danger font-weight-bold"
          >
            El campo "ID de interacción" solo puede contener letras y números.
          </small>
        </div>
      </div>
    </div>
    <!-- <div class="col-12 col-md-4">
            <div class="form-group row">
                <label class="col-sm-4 col-form-label text-right">Tipo de llamada:</label>
                <div class="col-sm-8">
